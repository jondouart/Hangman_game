...
words = ["python", "programming", "hangman", "developer", "computer", "фрукт", "овощь", "яблоко", "банан", "игра", "слова", "животное", 
        "space", "word", "games", "слон", "гипард", "апельсин", "сообщение", "произведение", "контекст", "совещание", "экспорт", "огород", "дача"
         "ркнесанс", "искуство", "филь", "предмет", "флософия", "энтропия", "трансформер", "безмятежность", "перспектива", "эгоцинтризм", "Вавилон",
         "Меркурий", "экспедиция", "телефон", "эскимо", "виолончель", "скипидар", "виноград", "садовник", "трамплин", "мелодия", "карантин",
         "капитан", "переход", "велосипед", "метеорит", "пространство", "девольвация", "модернизация"
        ]
